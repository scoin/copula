...
module.exports = function(hostname, port){
    ...
    console.log("ON INIT")
    //------------------------------------------------
    context.events.onInit.call(globalsHandler.get(), function(){
        ...
        var startup = context.events.beforeStart.bind(globalsHandler.get());
        var afterStart = context.events.afterStart.bind(globalsHandler.get());
        var shutdown = context.events.shutdown.bind(globalsHandler.get());
